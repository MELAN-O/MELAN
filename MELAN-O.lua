...
if not DevRio:get(Server.."Idvenom") then 
...
DevRio:set(Server.."Idvenom",DevId) 
end ---ifok
else 
os.execute('lua MELAN-O.lua') 
end 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MELAN-O/TroxFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/MELAN-O/TroxFiles/master/TroxFiles/"..FileName)
if Res == 200 then
