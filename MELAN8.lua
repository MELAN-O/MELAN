...
./tg -s ./MELAN8.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
os.execute('rm -rf MELAN8.lua') 
os.execute('wget https://raw.githubusercontent.com/MELAN-O/MELAN/master/MELAN8.lua') 
dofile('MELAN8.lua') 
